...
<template>
  <section class="bg-black h-screen w-screen relative p-10">
    <div class="text-white text-center text-3xl">Welcome To My Portfolio</div>

    <div class="mx-auto flex items-center justify-center my-10">
      <div
